  ...
  <header class="bg-slate-800 shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-16">
        <!-- Logo -->
        <router-link to="/temp1frontend" class="flex items-center space-x-2">
          <span class="text-xl font-bold text-white">Ecommerce</span>
        </router-link>

        <!-- Nav (Desktop) -->
        <nav class="hidden md:flex items-center space-x-6">
          <router-link to="/temp1frontend" class="text-slate-200 hover:text-white transition-colors font-medium">Home</router-link>
      ...
      >
        <nav class="flex flex-col space-y-1">
          <router-link to="/temp1frontend" class="px-4 py-2 text-slate-200 hover:bg-slate-700 hover:text-white rounded" @click="mobileMenuOpen = false">Home</router-link>
...
function handleLogout() {
  ...
  window.location.href = '/temp1frontend'
}
